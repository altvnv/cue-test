...
#SecretBackendRoleInitParameters: {
	...
	// Flag to allow wildcard certificates
	allowWildcardCertificates?: null | bool @go(AllowWildcardCertificates,*bool)
	...
	allowedUriSansTemplate?: null | bool @go(AllowedURISansTemplate,*bool)

	// Defines allowed User IDs
	// The allowed User ID's.
	allowedUserIds?: [...null | string] @go(AllowedUserIds,[]*string)
	...
	extKeyUsageOids?: [...null | string] @go(ExtKeyUsageOids,[]*string)
