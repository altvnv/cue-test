...
#MachineConfig: {
	...
	token?: null | string @go(MachineToken)
	...
	//       key:
	//         type: string
	ca?: null | string @go(MachineCA,*x509.PEMEncodedCertificateAndKey)
	...
	//       crt:
	//         type: string
	acceptedCAs?: [...null | string] @go(MachineAcceptedCAs,[]*x509.PEMEncodedCertificate)
...
#ClusterConfig: {
	...
	//       key:
	//         type: string
	ca?: null | string @go(ClusterCA,*x509.PEMEncodedCertificateAndKey)
	...
	//       crt:
	//         type: string
	acceptedCAs?: [...null | string] @go(ClusterAcceptedCAs,[]*x509.PEMEncodedCertificate)
	...
	//       key:
	//         type: string
	aggregatorCA?: null | string @go(ClusterAggregatorCA,*x509.PEMEncodedCertificateAndKey)
	...
	//         type: string
	//         additionalProperties: false
	serviceAccount?: null | string @go(ClusterServiceAccount,*x509.PEMEncodedKey)
...
#TimeConfig: {
	...
	bootTimeout?: string @go(TimeBootTimeout,time.Duration)
}
...
#EtcdConfig: {
	...
	//       key:
	//         type: string
	ca?: null | string @go(RootCA,*x509.PEMEncodedCertificateAndKey)
...
#ClusterNetworkConfig: {
	...
	//   examples:
	//     - value: '"cluser.local"'
	dnsDomain?: null | string @go(DNSDomain)
...
#RegistryTLSConfig: {
	...
	//       key:
	//         type: string
	clientIdentity?: null | string @go(TLSClientIdentity,*x509.PEMEncodedCertificateAndKey)
