...
#ApplicationSourceHelm: {
	...
	kubeVersion?: string @go(KubeVersion) @protobuf(12,bytes,opt)
...
#ApplicationSourceKustomize: {
	...
	// KubeVersion specifies the Kubernetes API version to pass to Helm when templating manifests. By default, Argo CD
	// uses the Kubernetes version of the target cluster.
	kubeVersion?: string @go(KubeVersion) @protobuf(15,bytes,opt)

	// APIVersions specifies the Kubernetes resource API versions to pass to Helm when templating manifests. By default,
	// Argo CD uses the API versions of the target cluster. The format is [group/]version/kind.
	apiVersions?: [...string] @go(APIVersions,[]string) @protobuf(16,bytes,opt)
}
...
#SyncOperation: {
	...
	autoHealAttemptsCount?: int64 @go(SelfHealAttemptsCount) @protobuf(12,bytes,opt)
}
...
#ApplicationTree: {
	...
	shardsCount?: int64 @go(ShardsCount) @protobuf(4,bytes,opt)
}
...
#ResourceActions: {
	...
	mergeBuiltinActions?: bool @go(MergeBuiltinActions) @protobuf(3,bytes,opt)
}
...
#AppProjectSpec: {
	...
	destinationServiceAccounts?: [...#ApplicationDestinationServiceAccount] @go(DestinationServiceAccounts,[]ApplicationDestinationServiceAccount) @protobuf(14,bytes)
}
...
#ApplicationDestinationServiceAccount: {
	...
	defaultServiceAccount: string @go(DefaultServiceAccount) @protobuf(3,bytes,opt)
}
